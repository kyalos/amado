                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="<?php echo base_url(); ?>uploads/<?php echo $row->image_1; ?>">
                                            <img class="d-block w-100" src="<?php echo base_url(); ?>uploads/<?php echo $row->image_1; ?>" alt="First slide">
                                        </a>
                                    </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <form class="cart clearfix" method="post" action="">
                                ...
                                <button type="submit" name="addtocart" value="5" class="btn amado-btn" onclick="updateCart()">Add to cart</button>
                            </form>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script type="text/javascript">
        ...
        function updateCart()
        {
            window.location.href = "<?php echo site_url('pages/product-details');?>";
        }
    </script>
