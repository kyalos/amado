        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li><a href="<?php echo base_url(); ?>pages/login_page">Login</a></li>
                </ul>
            </nav>
            <!-- Button Group -->
                            ...
                            <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo base_url(); ?>pages/login_page">Login</a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
...
<script type="text/javascript">
        ...
        {
            window.location.href = "<?php echo site_url('pages/view_product()/i');?>";
        }
        ...
        function getCompanyProducts(company)
        {
            ...
            window.location.href = "<?php echo site_url('pages/get_company_products(company)');?>";
        }
    </script>
