                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="cart_product_img">
                                            <a href="JavaScript(0)"><img src ="<?php echo base_url(); ?>uploads/<?php echo $row->image_1; ?>" alt="Product"></a>
                                        </td>
                                        <td class="cart_product_desc">
                                            <h5><?php echo $row->product_firstname; ?> <?php echo $row->product_lastname; ?></h5>
                                        </td>
                                        <td class="price">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <?php foreach ($prices as $row): ?>
                                ...
                                <li><span>total:</span> <span>$<?php echo $row->price; ?></span></li>
                            <?php endforeach; ?>
