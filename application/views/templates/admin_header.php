            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="<?php echo base_url(); ?>admin/add_new_product">
                                <i class="fas fa-copy"></i>Add new Product</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="<?php echo base_url(); ?>admin/products_list">
                                <i class="fas fa-desktop"></i>List of products</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/add_new_user">
                                <i class="fas fa-users"></i>Add new User</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="<?php echo base_url(); ?>admin/add_new_product">
                                <i class="fas fa-copy"></i>Add new product</a>
